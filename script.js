...
const DESCRIPTIONS = {
  ...
  'Berserk': 'Each hit has a 30% chance of causing enemies to go berserk for 6 seconds. Berserk enemies deal 15-24 damage to adjacent enemies every second.',
  ...
  'Incubus': 'Each hit has a 4% chance of charming the enemy for 9 seconds. Charmed enemies curse nearby enemies. Cursed enemies are dealt 100-200 after being hit 5 times.',
  ...
  'Lovestruck': 'Inflicts lovestruck on hit enemies for 20 seconds. Lovestruck units have a 50% chance of healing you for 5 health when they attack.',
  ...
  'Succubus': 'Each hit has a 4% chance of charming the enemy for 9 second. Heals 1 when hitting a charmed enemy.',
  ...
  'Satan': 'While active, add 1 stack of burn to all active enemies per second (max 5 stacks), dealing 10-20 damage perf stack per second and make them go berserk, dealing 15-24 damage to adjacent enemies every second.',
  ...
  "Deadeye's Cross": 'Increase critical hit chance to 60%.',
  ...
  'Phantom Regalia': 'Balls go through enemies until they hit the back wall. Balls deal 50% more damage when going through enemies.',
...
const PASSIVE_RECIPES = [
  ...
  { result: 'Odiferous Shell', ingredients: ['Breastplate', 'Wretched Onion'], type: 'passive' },
